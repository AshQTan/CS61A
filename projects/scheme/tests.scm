...
(car (cdr (cdr (cdr '(soylent green is people)))))
; expect people
...
(define greek (mu (k) (* k a) ))
; expect greek
(define letters (lambda (k a) (greek (+ k a))))
; expect letters
(letters 5 7)
; expect 84
...
(define (unexpected a b) (+ a b))
; expect unexpected
(unexpected 4 6)
; expect 10
(define bazinga (mu () (+ x z)))
; expect bazinga
(let ((x 9) (z 6))
  (unexpected 7 5)
  (begin
...
(define imagine (mu () (+ x y z)))
; expect imagine
(define all (mu (x y) (imagine)))
; expect all
(define the (mu (x y z) (all 5 3)))
; expect the
(define people (lambda (x y z) (all 0 9)))
; expect people
(people 9 6 7)
; expect 16
(the 5 3 0)
...
(+ (- (+ 0 1 1 2 3) (- 5 4)) (* 10 10 (+ 4 (/ 18 3) )2)(/ (- 57 (+ 3 4)) 5))
; expect 2016
