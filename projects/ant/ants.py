    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # Phase 4: Special handling for Ant
                # BEGIN Problem 7
                if self.ant != None:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is insect:
                if isinstance(insect, QueenAnt) and insect.one_true_queen == 1:
                    return
                if insect.container is True and insect.ant is not None:
                    self.ant = insect.ant
                else:
                    self.ant = None
            else:
                if hasattr(self.ant, 'container') and self.ant.container and self.ant.ant is insect:
                    if isinstance(self.ant.ant, QueenAnt) and self.ant.ant.one_true_queen == 1:
                        return
                    else:
                        self.ant.ant = None
                else:
...
class Ant(Insect):
    ...
    def can_contain(self, ant):
        if self.container is True and ant.container is not True and self.ant is None:
            return True
        else:
            return False
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        counter = 0
        while currentplace != hive:
            if random_or_none(currentplace.bees) != None:
                if counter in range(self.min_range, self.max_range):
...
# BEGIN Problem 5A
class WallAnt(Ant):
    """WallAnt does nothing each turn but has a high armor value."""
    name = 'Wall'
    food_cost = 4
    def __init__(self, armor=4):
        """Updates WallAnt ARMOR quantity."""
        Insect.__init__(self, armor)
    implemented = True
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def __init__(self):
        ...
        if QueenAnt.num_queens == 1:
            self.one_true_queen = QueenAnt.num_queens
    ...
    def action(self, colony):
        ...
        if self.one_true_queen != 1:
            ...
            while currentplace.exit is not None:
                if currentplace.ant is not None:
                    if currentplace.ant.container is True and currentplace.ant.ant is not None and currentplace.ant.ant not in QueenAnt.doubled:
                             currentplace.ant.ant.damage = currentplace.ant.ant.damage * 2
                             QueenAnt.doubled.append(currentplace.ant.ant)
                    if currentplace.ant not in QueenAnt.doubled:
                        currentplace.ant.damage = currentplace.ant.damage * 2
                        QueenAnt.doubled.append(currentplace.ant)
